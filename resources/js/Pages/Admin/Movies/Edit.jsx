...
export default function Edit({ movie, genres }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        genres: movie.genres.map((g) => String(g.id)),
        poster: null,
        _method: "put",
    });
    ...
    function submit(e) {
        e.preventDefault();
        post(`/admin/movies/${movie.id}`, { forceFormData: true });
    }
    ...
    return (
        <div className="space-y-8">
            <div className="flex items-start justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold">✏️ Edit movie</h1>
                    <p className="mt-1 text-sm text-gray-400">
                        Update details and optionally replace the poster.
                    </p>
                </div>
                ...
                <div className="rounded-2xl bg-zinc-800 border border-zinc-700 shadow overflow-hidden">
                    <div className="p-5 border-b border-zinc-700">
                        ...
                        <p className="text-sm text-gray-400 mt-1">
                            Current poster is shown below. Upload a new one to
                            replace.
                        </p>
                    </div>
